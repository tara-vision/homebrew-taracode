...
Formula updates are automated via GitHub Actions when a new taracode release is tagged. Manual updates are rarely needed.

If you need to update manually:

1. Get the SHA256 of the new release binaries:
   ```bash
   curl -sL https://github.com/tara-vision/taracode/releases/download/vX.Y.Z/taracode-darwin-arm64 | shasum -a 256
   curl -sL https://github.com/tara-vision/taracode/releases/download/vX.Y.Z/taracode-darwin-amd64 | shasum -a 256
   curl -sL https://github.com/tara-vision/taracode/releases/download/vX.Y.Z/taracode-linux-amd64 | shasum -a 256
   ```

2. Update `Formula/taracode.rb` with the new version and checksums
...
brew install ./Formula/taracode.rb
